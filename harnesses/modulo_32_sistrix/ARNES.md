...
1. ¿Están adjuntos los archivos del Módulo 32?
   - SÍ → comprueba además que el contenido corresponda realmente al
     Módulo 32 (nombres y temática reconocibles de la lista de
   ...
   - Si lo adjunto es claramente de otro módulo o tema → dilo
     ...
     32 — parece [tema detectado]. ¿Me lo confirmas o adjuntas los
   ...
   - Si no puedes leer el contenido del archivo (imagen escaneada,
     ...
     sea del Módulo 32. ¿Me confirmas que lo es, o me lo describes/
   ...
   - NO → DETENTE y di: "Necesito que adjuntes los archivos del
     Módulo 32. Sin ellos no puedo garantizar que mi respuesta venga
