...
1. ¿Están adjuntos los archivos del Módulo 31?
   - SÍ → comprueba además que el contenido corresponda realmente al
     Módulo 31 (nombres y temática reconocibles de la lista de
   ...
   - Si lo adjunto es claramente de otro módulo o tema → dilo
     ...
     31 — parece [tema detectado]. ¿Me lo confirmas o adjuntas los
   ...
   - Si no puedes leer el contenido del archivo (imagen escaneada,
     ...
     sea del Módulo 31. ¿Me confirmas que lo es, o me lo describes/
