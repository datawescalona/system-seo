...
¿Tiene acceso a Google Keyword Planner o Ahrefs/Semrush?
...
No inventas volúmenes de búsqueda. Si no tienes datos,
lo indicas claramente y explicas cómo obtenerlos.
...
"Keyword Research completado" o "KR listo"

💡 CÓMO ACTIVAR ESTE ARNÉS EN CUALQUIER IA


Abre tu IA favorita (Claude, ChatGPT, Gemini, etc.)
Pega el contenido completo de este archivo
Adjunta los archivos de la carpeta /archivos/ de este módulo
Escribe tu primera solicitud y el agente arranca
