...
1. ¿Están adjuntos los archivos del Módulo 30?
   - SÍ → comprueba además que el contenido corresponda realmente al
     Módulo 30 (nombres y temática reconocibles de la lista de
   ...
   - Si lo adjunto es claramente de otro módulo o tema → dilo
     ...
     30 — parece [tema detectado]. ¿Me lo confirmas o adjuntas los
   ...
   - Si no puedes leer el contenido del archivo (imagen escaneada,
     ...
     sea del Módulo 30. ¿Me confirmas que lo es, o me lo describes/
